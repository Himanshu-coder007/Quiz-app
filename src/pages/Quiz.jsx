        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-xl p-6 max-w-sm w-full shadow-xl">
            <div className="text-center">
              <div className={`mx-auto flex items-center justify-center h-12 w-12 rounded-full ${isCorrect ? 'bg-green-100' : 'bg-red-100'}`}>
                {isCorrect ? (
              ...
              <div className="mt-5">
                <button
                  ...
                  className={`inline-flex justify-center px-4 py-2 text-sm font-medium text-white rounded-md ${
                    ...
                    isCorrect ? 'focus:ring-green-500' : 'focus:ring-blue-500'
                  }`}
                >
